...
HD_PWD='/home/hello/32-Bit-ALU/32-Bit-ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lessThan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lessThan.tcl -notrace
