...
HD_PWD='/home/2018csb1094/32-Bit-ALU/32-Bit-ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fastAdder32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fastAdder32.tcl
