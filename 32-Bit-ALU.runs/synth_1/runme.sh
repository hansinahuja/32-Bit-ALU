...
HD_PWD='/home/hello/32-Bit-ALU/32-Bit-ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lessThan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lessThan.tcl
