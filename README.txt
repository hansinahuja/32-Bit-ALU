...
2) carry:
	...
	else if control = 2: 	stores carry generated by subtraction of A and B, ie carry = 1 for a 				     	positive result and carry = 0 for a negative result
	else:			carry = 0
...
4) lessthan:
	if control = 0, 1, 2, 7, 8 or 10:	lessthan = 1 if A < B. Else, lessthan = 0.
	else:					lessthan = 0
